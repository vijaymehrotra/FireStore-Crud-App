...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyViewHolder> {
    ...
    public void updateData(int position){
        ...
        bundle.putString("uDisc" ,item.getDisc());
        ...
        db.collection("Documents").document(item.getId()).delete().addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful()){
                    ...
                    Toast.makeText(activity, "Errie", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.desc.setText(mList.get(position).getDisc());
    }
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            desc = itemView.findViewById(R.id.disc_text);
        }
    }
}